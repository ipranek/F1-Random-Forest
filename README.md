...
Machine Learning: scikit-learn: Random Forest Classifier and Regressor <br/>
Data storage and preprocessing: SQLite, Pandas, NumPy <br/>
Model Explanation: SHAP <br/>
NLP Interface: LangChain

# Modelling Approach:

Random Forest Classifier --> to model the probability of seeing if someone who gets pole position can end up on the podium that same weekend. Class imbalance is handled with SMOTE, and the final accuracy is 86%. <br/>
